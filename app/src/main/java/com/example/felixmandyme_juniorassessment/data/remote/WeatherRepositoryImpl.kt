...
class WeatherRepositoryImpl @Inject constructor(private val weatherApi: WeatherApi):
    ...
    override suspend fun getWeatherInfo(): TemperatureResponse = weatherApi.getWeather(apiKey = API_KEY, location = "10001")
    override suspend fun getAstronomyInfo(): SunriseSunsetResponse = weatherApi.getAstronomy(apiKey = API_KEY, location = "10001", date = currentDate)
}